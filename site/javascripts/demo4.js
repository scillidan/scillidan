const s = (p) => {
  ...
  p.preload = () => {
    audio = p.loadSound('assets/audio/vistula.short_cr.ogg')
    demo4Shader = p.loadShader('assets/shaders/base.vert', 'assets/shaders/d4.frag')
    img = p.loadImage('assets/grass.png')
    d_map = p.loadImage('assets/clouds.jpg')
  }
